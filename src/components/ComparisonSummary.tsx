...
export function ComparisonSummary({ id, primary, comparison, primarySelection, comparisonSelection, onClose }: { id?: string; primary: Prediction; comparison: Prediction; primarySelection?: SelectionFact | null; comparisonSelection?: SelectionFact | null; onClose: () => void }) {
  return <section id={id} className="comparison-summary" aria-label={`Comparing ${primary.label} with ${comparison.label}`}>
