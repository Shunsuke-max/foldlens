...
describe('grounded assistant evaluation set', () => {
  ...
  const cases: Array<{
  ...
  }> = [
    {
      ...
      question: 'Is the Q–S interface reliable?',
      facts: baseFacts,
      plan: { intent: 'interface_reliability', evidenceRefs: ['primary_interface_iptm', 'primary_interface_pae'], language: 'en', followUpIntents: ['regional_uncertainty', 'falsification'] },
    ...
    },
    {
      ...
      facts: baseFacts,
      plan: { intent: 'regional_uncertainty', evidenceRefs: ['lowest_confidence_region'], language: 'ja', followUpIntents: ['falsification'] },
    ...
    },
    {
      ...
      facts: selectedFacts,
      plan: { intent: 'selection_support', evidenceRefs: ['active_selection_pae'], language: 'en', followUpIntents: ['alternative_interpretation'] },
    ...
    },
    {
      ...
      facts: baseFacts,
      plan: { intent: 'scope_boundary', evidenceRefs: [], language: 'en', followUpIntents: ['overall_assessment'] },
      expectedText: /cannot establish biological function/i,
    },
    {
      name: 'structural region priority',
      question: 'Which domain should I inspect first?',
      facts: baseFacts,
      plan: { intent: 'structural_region_priority', evidenceRefs: ['top_structural_region_plddt'], language: 'en', followUpIntents: ['regional_uncertainty'] },
    ...
    },
    {
      ...
      facts: baseFacts,
      plan: { intent: 'comparison', evidenceRefs: ['overall_ptm'], language: 'en', followUpIntents: ['overall_assessment'] },
